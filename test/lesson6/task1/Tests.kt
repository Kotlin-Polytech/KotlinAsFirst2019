...
class Tests {
    ...
    fun flattenPhoneNumber() {
        ...
        assertEquals("", flattenPhoneNumber("+42(--)89"))
        assertEquals("", flattenPhoneNumber("+42(56 -- 67)-"))
    }
    ...
    fun mostExpensive() {
        ...
        assertEquals("", mostExpensive("Курица молоко"))
    }
    ...
    fun fromRoman() {
        ...
        assertEquals(-1, fromRoman("CDCCC"))
    }
    ...
    fun computeDeviceCells() {
        ...
        assertThrows(IllegalArgumentException::class.java) { computeDeviceCells(10, "+>+>[+>", 3) }
        assertThrows(IllegalArgumentException::class.java) { computeDeviceCells(0, "[>]][[<]>]", 0) }
